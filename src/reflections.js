...
async function mount(){
 ...
 try{
  ...
  box.innerHTML=`<div class="reflection-editor" ${mine?'hidden style="display:none"':''}><label>Your private reflection</label><textarea placeholder="Write what you’re thinking…"></textarea><button class="save-reflection">Save Reflection</button><small>Private to you. Pastor Ryan and teammates cannot see this.</small></div>${mine?'<small class="reflection-saved-note">Reflection saved — find it under Profile → Reflections.</small>':''}`;

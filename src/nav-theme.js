...
.bottom-nav.five{min-height:84px!important;padding:8px 6px calc(8px + env(safe-area-inset-bottom))!important;grid-template-columns:repeat(5,1fr)!important;background:#080808!important;border-top:1px solid #343434!important}
.bottom-nav.five button{min-height:58px!important;padding:6px 2px!important;font-size:10px!important;font-weight:800!important;gap:4px!important;line-height:1.05!important;border-radius:10px!important}
.bottom-nav.five button>span:first-child{font-size:22px!important;line-height:1!important;min-height:24px!important;display:grid!important;place-items:center!important}
...
.composer{bottom:calc(84px + env(safe-area-inset-bottom))!important}
...
new MutationObserver(()=>setTimeout(retheme,50)).observe(document.documentElement,{childList:true,subtree:true});window.addEventListener('load',retheme);setInterval(retheme,1500);